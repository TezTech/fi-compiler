module.exports = function(core){
	var 
		...
		methods = ['abs','add','assert','concat','concat_ws','delegate','div','drop','get','hash','if','in','isset','length','mod','mul','neg','new','none','pack','pop','push','set','slice','sqr','sub','throw','to_address','to_contract','to_int','to_nat','to_optional','to_pkh','to_some','transfer','unpack','verify'];
